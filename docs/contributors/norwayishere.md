...
- **Task:** AI integration spec + discussion #206 created; synced branch with develop.
- **Blockers:** None
...
- 2026-04-28: Resolved conflicts on PR #187 (develop → main). Released v1.1.7 to Open VSX. Opened issue #204 (invite link button bug). Created AI integration discussion #206 and spec at docs/superpowers/specs/2026-04-28-ai-integrated-design.md.
