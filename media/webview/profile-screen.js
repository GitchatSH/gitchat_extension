(function () {
  ...
  function renderSkeletonHtml(username) {
    return [
      ...
      '        <div class="gs-pc-header-actions">',
      '          <div class="gs-pc-skel-btn-icon"></div>',
      '          <div class="gs-pc-skel-btn-pill"></div>',
      '        </div>',
      '      </div>',
      '      <div class="gs-pc-skel-line gs-pc-skel-lg"></div>',
      '      <div class="gs-pc-skel-line gs-pc-skel-sm"></div>',
      '      <div class="gs-pc-skel-line"></div>',
      '      <div class="gs-pc-skel-line gs-pc-skel-md"></div>',
      '    </div>',
      '    <div class="gs-pc-skel-stats-row">',
      '      <div class="gs-pc-skel-line gs-pc-skel-sm"></div>',
      '    </div>',
      '    <div class="gs-pc-skel-section">',
      '      <div class="gs-pc-skel-line gs-pc-skel-xs"></div>',
      '      <div class="gs-pc-skel-line"></div>',
      '    </div>',
      '    <div class="gs-pc-skel-section">',
      '      <div class="gs-pc-skel-line gs-pc-skel-xs"></div>',
      '      <div class="gs-pc-skel-repo"></div>',
      '      <div class="gs-pc-skel-repo"></div>',
      '    </div>',
      '  </div>',
      '</div>',
  ...
  // ProfileScreen = full sidebar-takeover profile view (repurposed full card
  // overlay — see docs/superpowers/plans/2026-04-14-profile-split.md). Named
  // a "screen" because it behaves like the Chat screen (pushes onto navStack).
  // The lightweight hover popover is the real "card" and lives in profile-card.js.
