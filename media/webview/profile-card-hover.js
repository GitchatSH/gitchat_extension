(function () {
  ...
  // Hover popover — lightweight preview of a user profile, anchored to trigger.
  // Shares host message protocol with profile-card.js (profileCard:fetch / profileCardData).
  // Clicking "View Profile" inside escalates to the full overlay via window.ProfileCard.show.
